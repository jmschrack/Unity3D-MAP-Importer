...
public static class ReaderExt{
    ...
    public static string ToReverseString(this uint value){
        
        return System.Text.Encoding.UTF8.GetString(BitConverter.GetBytes(value.ReverseBytes()));
    }
    ...
    public static string ReadUTF8String(this BinaryReader reader, int length){
        List<byte> bytes = new List<byte>();
        //bool reverse=reader.GetType()!=typeof(BigEndianReader);
    ...
    public static string ReadReverseUTF8String(this BinaryReader reader, int length){
